        ...
        <section class="top-link-section flex-row white-text">
            <section class="left-side flex-row">
                ...
                <span class="link-w-icon flex-row">
                    <p>Follow us on</p>
                    <a href="#">
                        <img src="<?php echo htmlspecialchars(ICON_PATH . 'facebook_w.svg'); ?>" alt="Facebook link" title="Facebook link" height="16" width="16">
                    </a>
                    <a href="#">
                        <img src="<?php echo htmlspecialchars(ICON_PATH . 'instagram_w.svg'); ?>" alt="Instagram link" title="Instagram link" height="16" width="16">
                    </a>
                    <a href="#">
                        <img src="<?php echo htmlspecialchars(ICON_PATH . 'tiktok_w.svg'); ?>" alt="Tiktok link" title="Tiktok link" height="16" width="16">
                    </a>
                </span>
            </section>
            ...
            <section class="right-side flex-row flex-child-end-v">
                <a class="link-w-icon flex-row" href="#">
                    <img src="<?php echo htmlspecialchars(ICON_PATH . 'notification.svg'); ?>" alt="Notification" title="Notification" height="16" width="16">
                    <p class="white-text">Notification</p>
                </a>

                <a class="link-w-icon flex-row" href="#">
                    <img src="<?php echo htmlspecialchars(ICON_PATH . 'help.svg'); ?>" alt="Help" title="Help" height="16" width="16">
                    <p class="white-text">Help</p>
                </a>

                <a class="link-w-icon flex-row" href="#">
                    <img src="<?php echo htmlspecialchars(ICON_PATH . 'user-profile.svg'); ?>" alt="User profile" title="User profile" height="16" width="16">
        ...
        <section class="lower-header-body flex-row">
            ...
            <section class="search-section flex-child-center-h">
                <form class="flex-row" action="" method="GET">
                    ...
                    <button class="search-button black-bg center-child" type="submit">
                        <img src="<?php echo htmlspecialchars(ICON_PATH . 'search.svg'); ?>" alt="Search button" title="Search button" height="16">
                    </button>
                </form>
            </section>
            ...
            <span class="icon-section flex-row flex-child-center-h">
                ...
                <div class="icon-w-badge">
                    ...
                    <a href="#">
                        <img src="<?php echo htmlspecialchars(ICON_PATH . 'cart.svg'); ?>" alt="Shoppingcart" title="Shoppingcart" height="32">
                    </a>
                </div>
                ...
                <div class="icon-w-badge">
                    ...
                    <a href="#">
                        <img src="<?php echo htmlspecialchars(ICON_PATH . 'chat_w.svg'); ?>" alt="Chat" title="Chat" height="32">
                    </a>
                </div>
            </span>
        </section>
