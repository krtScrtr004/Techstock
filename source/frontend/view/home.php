...
<body class="home flex-col">
    ...
    <script type="module" src="<?= htmlspecialchars(EVENT_PATH . 'chat' . DS . 'open.js'); ?>" defer></script>
    <script type="module" src="<?= htmlspecialchars(EVENT_PATH . 'chat' . DS . 'scroll-up.js'); ?>" defer></script>
